...
folder="swat_vitb32_ablate_sampling_methods"
...
# retrieval_splits=("Random500" "T2I500" "I2I500" "I2T500")
# retrieval_splits=("I2T10" "I2T20" "I2T50")
retrieval_splits=("T2T10" "T2T20" "T2T50")
