...
def plot_results(dataset):
    ...
    plt.xticks(x_fs, fontsize=15)

    if dataset == 'dtd':
        plt.yticks(np.arange(40, 80, 10), fontsize=15)
    elif dataset == 'semi-aves':
        plt.yticks(np.arange(0, 70, 10), fontsize=15)
    elif dataset == 'food':
        plt.yticks(np.arange(72, 82, 2), fontsize=15)   
    elif dataset == 'cars':
        plt.yticks(np.arange(65, 90, 5), fontsize=15) 
    elif dataset == 'imagenet':
        plt.yticks(np.arange(58, 68, 2), fontsize=15)  
    elif dataset == 'pets':
        plt.yticks(np.arange(84, 92, 2), fontsize=15)                                
    ...
    handles.insert(0, handles.pop(swat_index))
    labels.insert(0, labels.pop(swat_index))

    ft_fs_index = labels.index('FT on few-shot (ours)')
    handles.insert(1, handles.pop(ft_fs_index))
    labels.insert(1, labels.pop(ft_fs_index))

    ft_retr_index = labels.index('FT on retrieved (ours)')
    handles.insert(2, handles.pop(ft_retr_index))
    labels.insert(2, labels.pop(ft_retr_index))
