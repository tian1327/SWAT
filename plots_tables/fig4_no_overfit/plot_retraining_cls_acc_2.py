...
def plot_mean_std(mean_list, std_list, dataset_list):
    ...
    plt.tight_layout()
    # plt.savefig(f'no_overfit_all_flowers.png', dpi=300)
    # plt.savefig(f'no_overfit_all_eurosat_pets_cars.png', dpi=300)
    # plt.savefig(f'no_overfit_all_food.png', dpi=300)
    plt.savefig(f'no_overfit_{dataset}.png', dpi=300)
